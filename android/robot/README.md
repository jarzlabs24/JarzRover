...
This is the primary JarzRover robot-brain app for an Android phone mounted on the rover. The currently supported JARzLabs reference path connects the phone to an Arduino Nano over USB OTG using the documented OpenBot DIY protocol and pin configuration. See the public [compatibility notes](../../body/jarzrover-diy/COMPATIBILITY.md) and [test log](../../docs/TEST_LOG.md) before changing firmware or wiring assumptions. Complete wiring details are maintained in the private customer package.
